...
public class ModItems {
    ...
    */
    ...
    public static final RegistryObject<Item> PLUSH_CHEERILEE = ITEMS.register("plush_cheerilee",
            () -> new PlushItem(ModSounds.CHEERILEE1.get(),ModSounds.CHEERILEE2.get(),ModSounds.STEREO_CHEERILEE1.get(),ModSounds.STEREO_CHEERILEE2.get(), PlushReg.PLUSH_CHEERILEE.get(), new Item.Properties()));
    public static final RegistryObject<Item> PLUSH_SPITFIRE = ITEMS.register("plush_spitfire",
            () -> new PlushItem(ModSounds.SPITFIRE1.get(),ModSounds.SPITFIRE2.get(),ModSounds.STEREO_SPITFIRE1.get(),ModSounds.STEREO_SPITFIRE2.get(), PlushReg.PLUSH_SPITFIRE.get(), new Item.Properties()));
    public static final RegistryObject<Item> PLUSH_CHERRY_BERRY = ITEMS.register("plush_cherry_berry",
            () -> new PlushItem(ModSounds.CHERRY_BERRY1.get(),ModSounds.CHERRY_BERRY2.get(),ModSounds.STEREO_CHERRY_BERRY1.get(),ModSounds.STEREO_CHERRY_BERRY2.get(), PlushReg.PLUSH_CHERRY_BERRY.get(), new Item.Properties()));
    public static final RegistryObject<Item> PLUSH_SUGAR_BELLE = ITEMS.register("plush_sugar_belle",
            () -> new PlushItem(ModSounds.SUGAR_BELLE1.get(),ModSounds.SUGAR_BELLE2.get(),ModSounds.STEREO_SUGAR_BELLE1.get(),ModSounds.STEREO_SUGAR_BELLE2.get(), PlushReg.PLUSH_SUGAR_BELLE.get(), new Item.Properties()));
    public static final RegistryObject<Item> PLUSH_TWILIGHT_VELVET = ITEMS.register("plush_twilight_velvet",
            () -> new PlushItem(ModSounds.TWILIGHT_VELVET1.get(),ModSounds.TWILIGHT_VELVET2.get(),ModSounds.STEREO_TWILIGHT_VELVET1.get(),ModSounds.STEREO_TWILIGHT_VELVET2.get(), PlushReg.PLUSH_TWILIGHT_VELVET.get(), new Item.Properties()));
    public static final RegistryObject<Item> PLUSH_LIGHTNING_DUST = ITEMS.register("plush_lightning_dust",
            () -> new PlushItem(ModSounds.LIGHTNING_DUST1.get(),ModSounds.LIGHTNING_DUST2.get(),ModSounds.STEREO_LIGHTNING_DUST1.get(),ModSounds.STEREO_LIGHTNING_DUST2.get(), PlushReg.PLUSH_LIGHTNING_DUST.get(), new Item.Properties()));
